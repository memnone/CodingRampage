...
#pragma once
#ifndef _RAMPAGE_SYS_MESSAGESTREAM_H_
#define _RAMPAGE_SYS_MESSAGESTREAM_H_

//------------------------------------------------------------------------------

#include <Rampage/Sys/Message.h>
#include <Rampage/Defs/Queue.h>
...
protected:
	rampage::queue<Message> messages;
	MSecTmU32 threadTimeOut;
	Thread thread;
	Event evQueue;
...
#endif /*_RAMPAGE_SYS_MESSAGESTREAM_H_*/

...
#pragma once
#ifndef _RAMPAGE_SYS_MESSAGE_H_
#define _RAMPAGE_SYS_MESSAGE_H_
...
/** Rampage standard message/exception with information about thread id and time stamp. 
*/
